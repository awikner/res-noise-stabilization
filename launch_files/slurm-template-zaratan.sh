...
#SBATCH --output=/scratch/zt1/project/edott-prj/user/awikner1/res-noise-stabilization/log_files/${JOB_NAME}.log
#SBATCH -t ${RUNTIME}
#SBATCH -A ${ACCOUNT}
${GIVEN_NODE}
...
# ulimit -c 0
source /home/awikner1/miniconda3/etc/profile.d/conda.sh
${LOAD_ENV}
ifray=${IFRAY}
