    ...
    if noise_realizations == 1:
        ...
        for i in range(noise_realizations):
            ...
            if i == 0:
                ...
                pass_data = u_arr_train_noise[:,skip:-1]
            else:
                pass_data = np.append(pass_data,  u_arr_train_noise[:,skip:-1], axis = 1)
...
def main(argv):
    ...
    folder = 'noisetest_%dnodes_%dtrain_%dreals_test2/' % (res_size, train_time, noise_realizations)
