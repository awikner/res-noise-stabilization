...
discard_time = 500
traintypes   = ['gradientk1', 'regzerok4']
train_time   = 20000
res_size     = 500
noise_realizations = 1
noisetypes   = ['none','none']
tau          = 0.25
win_type     = 'full_0centered'
squarenodes  = True
system       = 'KS'
bias_type    = 'new_random'
noise_values_array_all = [np.logspace(-8,-4,21,base=10),\
                      np.logspace(-8,-6,11,base=10)]
reg_values_all         = [np.append(0.0, np.logspace(-10,-4,13,base=10)),\
                      np.append(0.0, np.logspace(-18,-4,29,base=10))]
